...
var $author$project$Main$sampleAboutPage = {
	...
	aA: $elm$core$Maybe$Just('Hometown'),
	aB: $elm$core$Maybe$Just('USA'),
	aG: $elm$core$Maybe$Just(
		$author$project$ResumePage$Types$ImageEmail('sampleEmail.png')),
	aS: 'Sample User With Long Name',
	a2: _List_fromArray(
		[
			$author$project$ResumePage$Types$GitHub('https://github.com/'),
			...
			$author$project$ResumePage$Types$LinkedIn('https://www.linkedin.com/'),
			$author$project$ResumePage$Types$Website('https://www.google.com/')
		]),
	a4: $elm$core$Maybe$Just('Massachusetts')
};
var $author$project$ResumePage$Types$BootCamp = F5(
	function (school, website, startDate, endDate, info) {
		return {aI: endDate, X: info, ai: school, a3: startDate, a9: website};
	});
...
var $author$project$Main$sampleEducationPage = $elm$core$Maybe$Just(
	{
		ax: _List_fromArray(
			[
				A5(
				...
				_List_fromArray(
					[
						$author$project$ResumePage$Helpers$TextItem('Took a code camp to learn frontend development in React, JavaScript, and HTML/CSS'),
						$author$project$ResumePage$Helpers$TextItem('Learned about Git, CI/CD pipelines, and many other things'),
						$author$project$ResumePage$Helpers$TextItem('Looked into but didn\'t do much with Redux and VueJS as well'),
						A2($author$project$ResumePage$Helpers$LinkItem, 'https://www.github.com/', 'Link to my GitHub repo')
					]))
			]),
		aK: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$ResumePage$Helpers$TextItem('Took courses in several languages including Java, Python, and C++'),
						$author$project$ResumePage$Helpers$TextItem('Lerned Object Oriented Programming and similar concepts'),
						$author$project$ResumePage$Helpers$TextItem('Capstone project was building a Sudoku Solver and competing in a speed competition with it (got 2nd place)')
					]))
			]),
		aX: $author$project$ResumePage$Types$OtherEducation(
			_List_fromArray(
				[
					$author$project$ResumePage$Helpers$TextItem('Took some online courses at Udemy on JS and web technologies'),
					$author$project$ResumePage$Helpers$TextItem('Studied new languages on my own time like Elm (♥)'),
					$author$project$ResumePage$Helpers$TextItem('Participated in Code Colf and Euler Project to learn more'),
					$author$project$ResumePage$Helpers$TextItem('Did the Advent of Code in 2013 using Python'),
					A2($author$project$ResumePage$Helpers$LinkItem, 'https://www.github.com/', 'My Repo for AoC (Python)')
				]))
	});
...
var $author$project$Main$samplePortfolioPage = $elm$core$Maybe$Just(
	{
		aR: _List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						A2($author$project$ResumePage$Types$LinkCard, 'https://www.samplewebsite.com/', 'Link to site'),
						A2(
						$author$project$ResumePage$Types$TextCard,
						'Description',
						_List_fromArray(
							[
								$author$project$ResumePage$Helpers$TextItem('Helped build this website from scratch'),
								$author$project$ResumePage$Helpers$TextItem('Worked closely with the client to determine their needs'),
								$author$project$ResumePage$Helpers$TextItem('Used web best practices to make the site fast and responsively designed'),
								$author$project$ResumePage$Helpers$TextItem('Fully A11Y compliant!')
							])),
						$author$project$ResumePage$Types$ImageCard('sampleWebsiteImage.png'),
						A2(
						$author$project$ResumePage$Types$TextCard,
						'Tech Stack',
						_List_fromArray(
							[
								$author$project$ResumePage$Helpers$TextItem('Backend is NodeJS for their shopping portal'),
								A2($author$project$ResumePage$Helpers$LinkItem, 'https://nodejs.org', 'NodeJS'),
								$author$project$ResumePage$Helpers$TextItem('Database is SQLite'),
								$author$project$ResumePage$Helpers$TextItem('Frontend is in React based on Material Design CSS'),
								A2($author$project$ResumePage$Helpers$LinkItem, 'https://reactjs.org/', 'ReactJS'),
								A2($author$project$ResumePage$Helpers$LinkItem, 'https://material.io/', 'Material Design CSS')
							]))
					]))
			])
	});
...
var $author$project$Main$sampleSkillsPage = $elm$core$Maybe$Just(
	{
		a0: _List_fromArray(
			[
				A3($author$project$ResumePage$Types$Skill, 'Python', 3.5, 'Primary hobby language, no industry experience'),
				A3($author$project$ResumePage$Types$Skill, 'Elm', 2.0, 'Current hobby web language'),
				A3($author$project$ResumePage$Types$Skill, 'React', 3.0, 'Learned and used extensively in Code Camp, used to develop production apps'),
				A3($author$project$ResumePage$Types$Skill, 'Git', 3.5, 'Used extensively and have learned a lot about various obscure commands'),
				A3($author$project$ResumePage$Types$Skill, 'Java', 2.0, 'Haven\'t used much since college but still remember most of what I learned'),
				A3($author$project$ResumePage$Types$Skill, 'JavaScript', 3.5, 'Heavily used in industry experience, including production apps'),
				A3($author$project$ResumePage$Types$Skill, 'C++', 1.5, 'Learned the basics in college but haven\'t used since then'),
				A3($author$project$ResumePage$Types$Skill, 'C#', 3.5, 'Heavily used in industry experience, including several production apps'),
				A3($author$project$ResumePage$Types$Skill, 'Regex', 1.5, 'Learned about this during Code Golf -- Looks amazing, still learning')
			])
	});
...
var $author$project$Main$sampleWorkHistory = $elm$core$Maybe$Just(
	_List_fromArray(
		[
			A5(
			...
			_List_fromArray(
				[
					$author$project$ResumePage$Helpers$TextItem('Invented Google Wave'),
					$author$project$ResumePage$Helpers$TextItem('Worked on the team that made Google Reader'),
					$author$project$ResumePage$Helpers$TextItem('Did some other awesome stuff')
				])),
			A5(
			$author$project$ResumePage$Types$Job,
			...
			_List_fromArray(
				[
					$author$project$ResumePage$Helpers$TextItem('Helped to create custom solutions for clients'),
					A2($author$project$ResumePage$Helpers$LinkItem, 'https://www.google.com/search?q=integrated+solutions', 'Sample Solutions'),
					$author$project$ResumePage$Helpers$TextItem('Helped integrate our proprietary software into user\'s daily lives'),
					$author$project$ResumePage$Helpers$TextItem('Worked a lot with C#')
				])),
			A5(
			$author$project$ResumePage$Types$Job,
			...
			_List_fromArray(
				[
					$author$project$ResumePage$Helpers$TextItem('Worked as a summer intern on updating and managing websites for local businesses'),
					$author$project$ResumePage$Helpers$TextItem('Got to oversee and take the lead on local hardware store\'s website'),
					A2($author$project$ResumePage$Helpers$LinkItem, 'https://www.acehardware.com/', 'Ace Hardware')
				]))
		]));
var $author$project$Main$sampleResume = A5($author$project$Resume$Resume, $author$project$Main$sampleAboutPage, $author$project$Main$sampleWorkHistory, $author$project$Main$sampleEducationPage, $author$project$Main$sampleSkillsPage, $author$project$Main$samplePortfolioPage);
var $author$project$Main$initModel = F2(
	function (url, key) {
		return {G: key, p: 0, F: $author$project$Main$sampleResume, N: url};
	});
